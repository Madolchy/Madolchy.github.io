...
const DesktopIcon = React.memo(({ id, data, onMouseDownCallback, onMouseUpCallback, onCellDrop, onDoubleClick, onContextMenu }: DesktopIconProps) => {
    ...
    return (
        ...
        >
            <div
                className={`icon icon-grabbable flex items-center justify-center relative pointer-events-none shrink-0 ${isSelected ? "icon-highlight" : ""}`}
                style={{ zIndex: 2 }}
            >
